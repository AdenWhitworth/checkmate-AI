...
elo_ranges = {
    "output_data/less_1000.csv": "models/less_1000_model.h5",
    "output_data/1000_1500.csv": "models/1000_1500_model.h5",
    "output_data/1500_2000.csv": "models/1500_2000_model.h5",
    "output_data/greater_2000.csv": "models/greater_2000_model.h5"
}
...
for csv_file, model_file in elo_ranges.items():
    ...
    print(f"Model saved to {model_file.replace('.h5', '.keras')}")
