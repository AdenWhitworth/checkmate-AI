"""
Chess Game Simulation: Transformer V5/V6 vs Stockfish
================================================

This script simulates a chess game between the V5/V6 Transformer-based chess model (as White)
...
2. **Transformer Model Integration**:
   - Utilize a Transformer-based model V5/V6 to predict the best move during the game.
...
- Transformer Model Path: Path to the h5 model for the V5/V6 Transformer.
...
def play_transformer_turn(board, move_history, node, CHECKPOINT_DIR_OPENING, CHECKPOINT_DIR_MIDDLE):
    """
    ...
    Args:
        ...
        CHECKPOINT_DIR_OPENING (str): Path to the v5 Transformer Checkpoints.
        CHECKPOINT_DIR_MIDDLE (str): Path to the v6 Transformer Checkpoints.
...
def main(stockfish_path, CHECKPOINT_DIR_OPENING, CHECKPOINT_DIR_MIDDLE):
    """
    ...
    while not board.is_game_over():
        if board.turn:  # Transformer's turn (White)
            node, valid_move = play_transformer_turn(board, move_history, node, CHECKPOINT_DIR_OPENING, CHECKPOINT_DIR_MIDDLE)
            if not valid_move:
                break
...
if __name__ == "__main__":
    ...
    main(stockfish_path, CHECKPOINT_DIR_OPENING, CHECKPOINT_DIR_MIDDLE)